...
namespace ChameleonCoder.Resources
{
    public sealed class ResourceTypeInfo
    {
        public ResourceTypeInfo(string Alias, string DisplayName, ImageSource TypeIcon, Brush Background,
            Func<Type, Interfaces.IResource, string, Interfaces.IResource> Create, string author)
        {
            this.Alias = Alias;
        ...
        public Func<Type, Interfaces.IResource, string, Interfaces.IResource> Create { get; private set; }
