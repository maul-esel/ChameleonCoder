...
namespace ChameleonCoder.ResourceCore
{
    ...
    public class FileResource : ResourceBase
    {
        ...
        public override ImageSource Icon { get { return new System.Windows.Media.Imaging.BitmapImage(new Uri("pack://application:,,,/ChameleonCoder.ResourceCore;component/Images/file.png")); } }
