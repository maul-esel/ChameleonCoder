...
namespace ChameleonCoder.UI
{
    ...
    /// </summary>
    internal sealed partial class MainWindow : RibbonWindow, IAppComponent
    {
        public MainWindow(IChameleonCoderApp app)
        {
            App = app;

            DataContext = Model = new ViewModel.MainWindowModel(app);
            ...
            (FindResource("resTypeConv") as Converters.AppConverterBase).App = app;
        ...
        #region temp
        private void ModuleLoaded(object sender, Plugins.IModuleEventArgs e)
        {
            if (e.Module != null)
            {
        ...
        private void ModuleUnloaded(object sender, Plugins.IModuleEventArgs e)
        {
            if (e.Module != null)
            {
        ...
        private void ServiceExecute(object sender, Plugins.IServiceEventArgs e)
        {
            if (e.Service != null)
            {
        ...
        private void ServiceExecuted(object sender, Plugins.IServiceEventArgs e)
        {
            if (e.Service != null)
            {
        ...
        private void ResourceOpen(object sender, System.Windows.Input.MouseButtonEventArgs e)
        {
            ...
            if (resource == null)
            {
                var reference = TreeView.SelectedItem as Resources.IResourceReference;
                if (reference == null)
                    return;
        ...
        private void ResourceOpen(object sender, RoutedPropertyChangedEventArgs<BreadcrumbItem> e)
        {
            if (e.NewValue != null)
            {
                ...
                if (context != null)
                {
                    ...
                    ResourceOpen(App.ResourceMan.GetResourceFromDisplayPath(breadcrumb.PathFromBreadcrumbItem(e.NewValue), breadcrumb.SeparatorString));
