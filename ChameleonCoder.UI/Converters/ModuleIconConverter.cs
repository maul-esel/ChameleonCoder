...
namespace ChameleonCoder.UI.Converters
{
    ...
    public sealed class ModuleIconConverter : AppConverterBase, IValueConverter
    {
        /// <summary>
        ...
        public object Convert(object value, Type targetType, object parameter, System.Globalization.CultureInfo culture)
        {
            ...
            if (resource != null)
            {
                ...
                if (langRes != null)
                {
                    ...
                    {
                        ILanguageModule module = App.PluginMan.GetModule(langRes.Language);
                        if (module != null && module.Icon != null) // if so: return its icon
                            return App.PluginMan.GetModule(langRes.Language).Icon.GetAsFrozen(); // use GetAsFrozen() to avoid multi-threading issues
                    }
                }
