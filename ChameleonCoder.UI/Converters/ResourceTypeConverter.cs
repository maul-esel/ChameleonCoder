...
{
    /// <summary>
    /// this converter returns the "static" (localized) DisplayName of an IResource implementation, given a Type object
    /// </summary>
    [ValueConversion(typeof(Type), typeof(object))]
    public sealed class ResourceTypeConverter : AppConverterBase, IValueConverter
    {
        /// <summary>
        ...
        public object Convert(object value, Type targetType, object parameter, System.Globalization.CultureInfo culture)
        {
            ...
            if (type != null) // if cast successful
            {
                ...
                {
                    var displayName = App.ResourceTypeMan.GetDisplayName(type); // get the display name
                ...
                {
                    var icon = App.ResourceTypeMan.GetTypeIcon(type); // get the type icon
