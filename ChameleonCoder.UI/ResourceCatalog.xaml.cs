...
namespace ChameleonCoder.UI
{
    ...
    /// </summary>
    public sealed partial class ResourceCatalog : UserControl
    {
        /// <summary>
        /// creates a new instance of the ResourceCatalog control which displays all registered resources
        /// </summary>
        ...
        {
            ((sender as ResourceCatalog).TreeView.FindResource("Converter") as Converters.CollectionCombineConverter).IgnoreReferences = !(bool)e.NewValue;
        }
