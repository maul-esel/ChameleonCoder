...
namespace ChameleonCoder.Resources
{
    ...
    public interface IResource : INotifyPropertyChanged, IComponent
    {
        ...
        /// </summary>
        IResourceReference[] References { get; }
        ...
        [System.Obsolete]
        void Update(IObservableStringDictionary data, IResource parent, Files.IDataFile file);
        ...
        void AddReference(IResourceReference reference);
        ...
        /// <remarks>Always raise the <c>PropertyChanged</c> event on the <see cref="References"/> property when this method is called.</remarks>
        void RemoveReference(IResourceReference reference);
    }
}
